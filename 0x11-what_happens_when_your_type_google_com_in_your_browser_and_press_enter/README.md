...
and practicing over the last month, in this project, I wrote an article
...
* **0. What happens when...**
  * [0-blog_post](./0-blog_post): Text file containing the link to my LinkedIn article.
...
* **1. Everything's better with a pretty diagram**
  * [1-what_happen_when_diagram](./1-what_happen_when_diagram): Text file
  ...
  process described in my LinkedIn.
